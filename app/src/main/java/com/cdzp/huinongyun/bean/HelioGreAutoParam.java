 ...
 * 日光温室设备数据
 */
public class HelioGreAutoParam {
    ...
    private List<HelioGreDeviceInfo> list;

    public HelioGreAutoParam() {
        list = new ArrayList<>();
    }
    ...
    public List<HelioGreDeviceInfo> getList() {
        return list;
    }

    public void setList(List<HelioGreDeviceInfo> list) {
        this.list = list;
    }
}
