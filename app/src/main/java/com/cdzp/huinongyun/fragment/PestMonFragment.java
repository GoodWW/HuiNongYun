...
import com.cdzp.huinongyun.adapter.PestMonAdapter;
 ...
 * 虫情监控
 */
public class PestMonFragment extends Fragment implements View.OnClickListener {

    private Context context;
    private View view;
    private boolean isVisible, isStart;
    ...
    private PestMonAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.fragment_pest_mon, container, false);
            initView();
        }
        return view;
    }
    ...
    private void initView() {
        ...
        tv_tart = view.findViewById(R.id.tv_fpm_start);
        tv_end = view.findViewById(R.id.tv_fpm_end);
        tv_MonPoi = view.findViewById(R.id.tv_fpm_MonPoi);
        tv_time = view.findViewById(R.id.tv_fpm_time);
        ...
        mRefreshLayout = view.findViewById(R.id.mRefreshLayout_fpm);
        ...
        mRecyclerView = view.findViewById(R.id.mRecyclerView_fpm);
        mRecyclerView.setLayoutManager(new GridLayoutManager(context, 3));
        photoList = new ArrayList<>();
        mAdapter = new PestMonAdapter(getActivity());
        ...
        view.findViewById(R.id.ll_fpm1).setOnClickListener(this);
        view.findViewById(R.id.ll_fpm2).setOnClickListener(this);
        view.findViewById(R.id.ll_fpm3).setOnClickListener(this);
        view.findViewById(R.id.ll_fpm4).setOnClickListener(this);
        ...
        if (tv_MonPoi.getText().length() > 0 && tv_tart.getText().length() > 0 &&
            ...
            if (endDate.getTime() - startDate.getTime() < 30l * 24 * 60 * 60 * 1000 + 10000) {
                if (Data.userResult != null) {
                    ...
                    data.add(new String[]{"dataID", mList.get(mPosition1)[1]});
