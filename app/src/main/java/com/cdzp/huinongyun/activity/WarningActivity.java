 ...
 * 报警信息
 */
public class WarningActivity extends BaseActivity implements OnMenuItemClickListener {
    ...
    public void initView() {
        ...
        tv.setText(getString(R.string.warn_str1));
        ...
        String[] mTitles = new String[]{
                getString(R.string.warn_str2),
                getString(R.string.warn_str3),
                getString(R.string.warn_str4)
        };

        List<Fragment> mFragments = new ArrayList<>();
        mFragments.add(new RealTimeWarnFragment());
        mFragments.add(new HistoryWarnFragment());
        mFragments.add(new WarnSetFragment());

        MyViewPager mViewPager = findViewById(R.id.mViewPager_aw);
        MyPagerAdapter mAdapter = new MyPagerAdapter(getSupportFragmentManager(), mFragments, mTitles);
        mViewPager.setAdapter(mAdapter);

        SlidingTabLayout tabLayout = findViewById(R.id.mTabLayout_aw);
                ...
                case "1":
                    switch (position) {
                        case 1:
                            ...
                            break;
                        case 2:
//                        startActivity(WarningActivity.class, "1");
                            break;
                        case 3:
