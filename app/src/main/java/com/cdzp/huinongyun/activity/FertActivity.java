 ...
 * 施肥机
 */
public class FertActivity extends BaseActivity implements OnMenuItemClickListener {
    ...
    public void initView() {
        ...
        String[] mTitles = new String[]{
                ...
                getString(R.string.fert_str3)
        };
        List<Fragment> mFragments = new ArrayList<>();
        mFragments.add(new FertFragment());
        mFragments.add(new FertPlanParFragment());
        mFragments.add(new FertAutoParFragment());
